    ...
    <div class=" flex items-center justify-center" style="background: #edf2f7;">
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="container px-6 py-10 mx-auto">
                <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white text-center" >Data Barang</h1>

                <div class="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2">
                    @foreach ($data as $item)
                        <div class="lg:flex bg-gradient-to-r from-green-400 to-blue-500">
                            <img class="object-scale-down w-full h-56 rounded-full lg:w-64"
                                src="{{$item->gambar}}"
                                alt="">
