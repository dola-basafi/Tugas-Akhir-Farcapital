    ...
    <div class="w-full flex flex-wrap">
        ...
        <div class="w-full md:w-1/2 flex flex-col">
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                <p class="text-center text-3xl">Isi Form Regristrasi.</p>
                <form class="flex flex-col pt-3 md:pt-8" action="{{ route('register') }} " method="post">
                    @csrf
                    <div class="flex flex-col pt-4">
                        <label for="nama" class="text-lg">Name</label>
                        <input type="text" id="nama" name="nama" placeholder="Nama anda" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline" />
                    </div>
                    ...
                    <div class="flex flex-col pt-4">
                        ...
                        <input type="email" name="email" id="email" placeholder="emailAnda@email.com" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
                ...
                <div class="text-center pt-12 pb-12">
                    <p>sudah punya akun ? <a href="login" class="underline font-semibold">Masuk disini</a></p>
                </div>
            </div>
